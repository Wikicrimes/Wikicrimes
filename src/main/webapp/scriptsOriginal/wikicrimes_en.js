...
CrimeMarker.prototype = Object.extend(new GMarker(new GLatLng(0, 0)), {
    ...
    mostrarDados: function(idCrime) {
        ...
        this.openInfoWindowTabsHtml([new GInfoWindowTab('Details',myHtml),new GInfoWindowTab('Comments',myHtml2)]);
    }
...
function createMarkerTemp(point, tipoCrime)  {
	 ...
	 icone.shadow="/wikicrimes/images/baloes/shadow50.png";
	  ...
	  if (tipoCrime) {
	  		if (tipoCrime == 1)
               icone.image = "/wikicrimes/images/baloes/vermelho_hint_en.png";
  	  		if (tipoCrime == 2)
               icone.image = "/wikicrimes/images/baloes/azul_hint_en.png";
   	  		if (tipoCrime == 3)
               icone.image = "/wikicrimes/images/baloes/azul_hint_en.png";
   	  		if (tipoCrime == 4)
   	  		   icone.image = "/wikicrimes/images/baloes/vermelho_hint_en.png";
			if (tipoCrime == 5)
   	  		   icone.image = "/wikicrimes/images/baloes/laranja_hint_en.png";               
