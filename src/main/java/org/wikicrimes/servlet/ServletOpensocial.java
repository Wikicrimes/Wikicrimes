...
public class ServletOpensocial extends HttpServlet {
	...
	protected static void setUp() throws Exception {
		...
		try{
			...
			System.out.println("Sess�o j� aberta!");
		}	
		// setup code here
	}
	...
	protected static String codificaCaracteres(String descComentario){
		descComentario = descComentario.replaceAll("aagudo", "�");
		descComentario = descComentario.replaceAll("eagudo", "�");
		descComentario = descComentario.replaceAll("iagudo", "�");
		descComentario = descComentario.replaceAll("oagudo", "�");
		descComentario = descComentario.replaceAll("uagudo", "�");
		descComentario = descComentario.replaceAll("acircu", "�");
		descComentario = descComentario.replaceAll("ecircu", "�");
		descComentario = descComentario.replaceAll("icircu", "�");
		descComentario = descComentario.replaceAll("ocircu", "�");
		descComentario = descComentario.replaceAll("ucircu", "�");
		descComentario = descComentario.replaceAll("cagudo", "�");
		descComentario = descComentario.replaceAll("atil", "�");
		descComentario = descComentario.replaceAll("otil", "�");
		descComentario = descComentario.replaceAll("acrase", "�");
