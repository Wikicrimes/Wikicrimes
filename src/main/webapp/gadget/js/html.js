...
function conteudoInstallApp(){
	...
	conteudo +='		<tr>';
	conteudo +='			<td align="center">';
	conteudo +='				<input style="cursor: pointer;font-family: Arial, Helvetica, sans-serif; font-size: 10px;	font-weight: bold; margin: 1; padding: 1; background-color: #6da6e2; color: white;	border: 1px solid #2763a5;" type="button" value ="Sim" onclick="chamarTelaLogin();" />';
	conteudo +='			</td>';
	conteudo +='			<td align="center">';
	conteudo +='				<input style="cursor: pointer;font-family: Arial, Helvetica, sans-serif; font-size: 10px;	font-weight: bold; margin: 1; padding: 1; background-color: #6da6e2; color: white;	border: 1px solid #2763a5;" type="button" value ="Não" onclick="registrarUsuario();" />';
	conteudo +='			</td>';
	conteudo +='		</tr>';
	conteudo +='	</table>';
	conteudo +='</div>';
