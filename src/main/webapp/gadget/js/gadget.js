...
function initialize() {
	...
	//Este m�todo se encontra o arquivo requisicoes.js
	getPessoas();
	//Este m�todo se encontra o arquivo requisicoes.js	   				   					 			
}
...
function convideSeusAmigos() {
	...
	var params = {};
	params[opensocial.Message.Field.TITLE] = "Alerte seus amigos sobre regi�es perigosas com WikiCrimes Social.";
...
//	}else{			    
    	...
    	var htmlComentarios = "<br><div><img width=22px height=20px src="+ linkAplication+"images/widget/comentar.PNG" +" /> <b>"+usuarioRedeSocial.nome+" comenta:</b> </div><br/>";		
   		...
   		if(document.getElementById('comentarios').innerHTML == '<br>Nenhum coment�rio sobre esse alerta')
