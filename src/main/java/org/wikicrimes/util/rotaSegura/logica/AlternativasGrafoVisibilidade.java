...
//		/*TESTE*/teste.salvar();
	...
	//em cada passo da caminhada pela borda, n tao sendo processadas s� as 3 c�lulas como na ilustracao 1 (como foi planejado)
	//ta sendo processado como na ilustracao 2, pq n�o ta "voltando" pro "x" antes de ir pra cima e pra esquerda (erro de implementa��o mesmo)  
	//s� q, ao corrigir isso, p�ra de funcionar 
	...
	public List<Poligono> getPoligonosHotspots(Rectangle bounds, int verticesPulados){
		...
		final int perto = 1; //fecha o poligono msm se o inicio e fim msm nao tiverem se encontrado, se estiverem a esta dist�ncia
