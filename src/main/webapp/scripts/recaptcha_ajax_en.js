...
var user_opts = opts || {};
for (var p in user_opts) {
comb_opt[p] = user_opts[p];
}
...
challengeField.type="password";
challengeField.setAttribute("autocomplete", "off");
challengeField.style.display = "none";
challengeField.name="recaptcha_challenge_field";
challengeField.id="recaptcha_challenge_field";
$('recaptcha_response_field').parentNode.insertBefore(challengeField, $('recaptcha_response_field'));
...
$("recaptcha_image").innerHTML = embedCode + cantHearCode;
} else if (type == 'image') {
