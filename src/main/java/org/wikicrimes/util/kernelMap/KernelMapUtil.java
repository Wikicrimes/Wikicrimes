...
public class KernelMapUtil {
	...
	public static KernelMap fazerKernelMap(Rectangle boundsPixel, int zoom, CrimeService crimeService, Date dataInicial) {
		...
		KernelMap kernel = new KernelMap(GRID_NODE, BANDWIDTH, boundsPixel, crimes);
		return kernel;
	}
	
	private static Rectangle getBoundsPixel(PontoLatLng centro, double raioKm, int zoom) {
