//Solicita da rede social os dados do usu�rio logado e de seus amigos
function getPessoas(){	
...
//Resposta com os dados do usu�rio logado e de seus amigos
...
//Executa requisi��o para recuperar os crimes do banco
...
//Resposta requisi��o para recuperar os crimes do banco
function respostaRequisicaoListagem(obj){
	...
	if(responseText == "nao_permitir")
		alert("Voc� n�o tem permiss�o para acessar essa funcionalidade");
	else	
